        ...
        <div className="mt-[2rem]">
           ...
           <div className="rounded bg-opacity-40 text-gray-300 pb-1 mt-2 h-[50%]  m-auto bg-[#13121C] items-center text-center w-[25%] md:w-[25%] sm:w-[60%]">
               <form action="" onSubmit={submitHandler} className="items-center p-5">
                <input type="email" id="email" name="email" onChange={e => setEmail(e.target.value)} className="block mt-3 w-full m-auto border-blue-300 text-gray-300 required border-b-2  bg-transparent text-[1.1rem] p-2  focus:border-blue-700 focus:outline-none focus:active:border-blue-400 " placeholder="Email" />
                <input type="password" id="password" name="password" onChange={e => setPassword(e.target.value)} className="block mb-5 mt-3 w-full m-auto border-blue-300 required text-gray-300 border-b-2 bg-transparent text-[1.1rem] p-2  focus:border-blue-700 focus:outline-none focus:active:border-blue-400 " placeholder="Password" />
              ...
              <p className='my-4'>Dont have an account? <Link to={'/welcome/register'} className='ml-3 text-blue-500' >Sign up</Link></p>
           </div>
        </div>
      </header>
      <footer>
        <div className='mt-[1rem] bg-[#040421] grid grid-cols-4 bg-opacity-60 rounded-lg p-2 h-[10%] w-[80%] m-auto '>
          <div className='mr-10'>
            <BrainlyCodeIcon />
